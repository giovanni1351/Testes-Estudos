...
def test_deposito_com_log(carteira_com_log: CarteiraDigital):
    ...
    # Assert
    with open(carteira_com_log.log_path) as file:
        conteudo = file.readlines()[-1]
    assert str(valor_deposito) in conteudo and str(2000) in conteudo
